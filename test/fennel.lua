local function _1_(...)
  ...
  local function default_on_error(errtype, err, lua_source)
    local function _2f_616_()
      local _2f_615_0 = errtype
      if (_2f_615_0 == "Lua Compile") then
        return ("Bad code generated - likely a bug with the compiler:\n" .. "--- Generated Lua Start ---\n" .. lua_source .. "--- Generated Lua End ---\n")
      elseif (_2f_615_0 == "Runtime") then
  ...
  local function splice_save_locals(env, lua_source, scope)
    ...
    local function _2f_625_()
      local _2f_623_0, _2f_624_0 = lua_source:match("^(.*)[\n ](return .*)$")
      if ((nil ~= _2f_623_0) and (nil ~= _2f_624_0)) then
        local body = _2f_623_0
        local _return = _2f_624_0
  ...
  local function completer(env, scope, text)
    ...
    local function add_partials(input, tbl, prefix)
      ...
      for k, is_mangled in utils.allpairs(_2f_627_()) do
  ...
  local function reload(module_name, env, on_values, on_error)
    local _2f_638_0, _2f_639_0 = pcall(specials["load-code"]("return require(...)", env), module_name)
    if ((_2f_638_0 == true) and (nil ~= _2f_639_0)) then
      local old = _2f_639_0
      local _ = nil
      ...
      return on_values({"ok"})
    elseif ((_2f_638_0 == false) and (nil ~= _2f_639_0)) then
      local msg = _2f_639_0
      ...
      elseif specials["macro-loaded"][module_name] then
        ...
        local function _2f_644_()
          local _2f_643_0 = msg:gsub("\n.*", "")
          return _2f_643_0
        end
        return on_error("Runtime", _2f_644_())
      end
    else
      return nil
    end
  ...
  local function run_command(read, on_error, f)
    local _2f_647_0, _2f_648_0, _2f_649_0 = pcall(read)
    if (((_2f_647_0 == true) and (_2f_648_0 == true)) and (nil ~= _2f_649_0)) then
      local val = _2f_649_0
      local _2f_650_0, _2f_651_0 = pcall(f, val)
      if ((_2f_650_0 == false) and (nil ~= _2f_651_0)) then
        local msg = _2f_651_0
        return on_error("Runtime", msg)
      else
        return nil
      end
    elseif (_2f_647_0 == false) then
  ...
  commands.reload = function(env, read, on_values, on_error)
    local function _2f_654_(_2f_241)
      return reload(tostring(_2f_241), env, on_values, on_error)
    end
    return run_command(read, on_error, _2f_654_)
  end
  do
  end
  ...
  local function apropos_2a(pattern, tbl, prefix, seen, names)
    for name, subtbl in pairs(tbl) do
      if (("string" == type(name)) and (package ~= subtbl)) then
        local _2f_656_0 = type(subtbl)
        if (_2f_656_0 == "function") then
          if ((prefix .. name)):match(pattern) then
            table.insert(names, (prefix .. name))
          else
          end
        elseif (_2f_656_0 == "table") then
          if not seen[subtbl] then
            ...
            apropos_2a(pattern, subtbl, (prefix .. name:gsub("%.", "/") .. "."), _2f_658_, names)
          else
          end
        else
        end
    ...
    for _, path in ipairs(apropos(".*")) do
      ...
      do
        ...
        if ("function" == type(tgt)) then
          local _2f_667_0 = (compiler.metadata):get(tgt, "fnl/docstring")
          if (nil ~= _2f_667_0) then
            local docstr = _2f_667_0
  ...
  commands["apropos-doc"] = function(_env, read, on_values, on_error, _scope)
    local function _2f_671_(_2f_241)
      return on_values(apropos_doc(tostring(_2f_241)))
    end
    return run_command(read, on_error, _2f_671_)
  end
  do
  end
  ...
  commands["apropos-show-docs"] = function(_env, read, on_values, on_error)
    local function _2f_673_(_2f_241)
      return apropos_show_docs(on_values, tostring(_2f_241))
    end
    return run_command(read, on_error, _2f_673_)
  end
  do
  end
  ...
  local function resolve(identifier, _2f_674_0, scope)
    local _2f_675_ = _2f_674_0
    local env = _2f_675_
    local ___repl_locals___ = _2f_675_.___replLocals___
    local e = nil
    local function _2f_676_(_2f_241, _2f_242)
      return (___repl_locals___[scope.unmanglings[_2f_242]] or env[_2f_242])
    end
    e = setmetatable({}, {__index = _2f_676_})
    local function _2f_677_(...)
      local _2f_678_0, _2f_679_0 = ...
      if ((_2f_678_0 == true) and (nil ~= _2f_679_0)) then
        local code = _2f_679_0
        local function _2f_680_(...)
          local _2f_681_0, _2f_682_0 = ...
          if ((_2f_681_0 == true) and (nil ~= _2f_682_0)) then
            local val = _2f_682_0
            return val
          else
            local _ = _2f_681_0
        ...
        return _2f_680_(pcall(specials["load-code"](code, e)))
      else
        local _ = _2f_678_0
        return nil
      end
    end
    return _2f_677_(pcall(compiler["compile-string"], tostring(identifier), {scope = scope}))
  end
  commands.find = function(env, read, on_values, on_error, scope)
    local function _2f_685_(_2f_241)
      local _2f_686_0 = nil
      do
        local _2f_687_0 = utils["sym?"](_2f_241)
        if (nil ~= _2f_687_0) then
          local _2f_688_0 = resolve(_2f_687_0, env, scope)
          if (nil ~= _2f_688_0) then
            _2f_686_0 = debug.getinfo(_2f_688_0)
          else
            _2f_686_0 = _2f_688_0
          end
        else
      ...
      if (((((_G.type(_2f_686_0) == "table") and (nil ~= _2f_686_0.linedefined)) and (nil ~= _2f_686_0.short_src)) and (nil ~= _2f_686_0.source)) and (_2f_686_0.what == "Lua")) then
        local line = _2f_686_0.linedefined
        local src = _2f_686_0.short_src
        local source = _2f_686_0.source
        local fnlsrc = nil
        do
          local _2f_691_0 = compiler.sourcemap
          if (nil ~= _2f_691_0) then
            _2f_691_0 = _2f_691_0[source]
          else
          end
          if (nil ~= _2f_691_0) then
            _2f_691_0 = _2f_691_0[line]
          else
          end
          if (nil ~= _2f_691_0) then
            _2f_691_0 = _2f_691_0[2]
          else
          end
          fnlsrc = _2f_691_0
        end
        return on_values({string.format("%s:%s", src, (fnlsrc or line))})
      elseif (_2f_686_0 == nil) then
    ...
    return run_command(read, on_error, _2f_685_)
  end
  do
  end
  ...
  commands.doc = function(env, read, on_values, on_error, scope)
    ...
    return run_command(read, on_error, _2f_696_)
  end
  do
  end
  ...
  commands.compile = function(env, read, on_values, on_error, scope)
    local function _2f_699_(_2f_241)
    ...
    return run_command(read, on_error, _2f_699_)
  end
  do
  end
  ...
  local function load_plugin_commands(plugins)
    for i = #(plugins or {}), 1, ( - 1) do
      for name, f in pairs(plugins[i]) do
        local _2f_701_0 = name:match("^repl%-command%-(.*)")
        if (nil ~= _2f_701_0) then
          local cmd_name = _2f_701_0
          commands[cmd_name] = f
        else
        end
      end
  ...
  local function run_command_loop(input, read, loop, env, on_values, on_error, scope, chars)
    ...
    do
      local _2f_703_0 = commands[command_name]
      if (nil ~= _2f_703_0) then
        local command = _2f_703_0
  ...
  local function repl(_3foptions)
    ...
    local _2f_712_ = utils.copy(_3foptions)
    local opts = _2f_712_
    local _3ffennelrc = _2f_712_.fennelrc
    local _ = nil
    opts.fennelrc = nil
    _ = nil
    ...
    local function _2f_714_(_2f_241)
      return callbacks.readChunk(_2f_241)
    end
    byte_stream, clear_stream = parser.granulate(_2f_714_)
    local chars = {}
    local read, reset = nil, nil
    local function _2f_715_(parser_state)
    ...
    read, reset = parser.parser(_2f_715_)
    depth = (depth + 1)
    ...
    if opts.registerCompleter then
      local function _2f_721_()
        local _2f_720_0 = opts.scope
        local function _2f_722_(...)
          return completer(env, _2f_720_0, ...)
        end
        return _2f_722_
      end
      opts.registerCompleter(_2f_721_())
    else
    end
    ...
    local function loop(exit_next_3f)
      ...
      elseif command_3f(src_string) then
        ...
        if not_eof_3f then
          local function _2f_726_(...)
            local _2f_727_0, _2f_728_0 = ...
            if ((_2f_727_0 == true) and (nil ~= _2f_728_0)) then
              local src = _2f_728_0
              local function _2f_729_(...)
                local _2f_730_0, _2f_731_0 = ...
                if ((_2f_730_0 == true) and (nil ~= _2f_731_0)) then
                  local chunk = _2f_731_0
                  local function _2f_732_()
                    return print_values(save_value(chunk()))
                  end
                  local function _2f_733_(...)
                    return callbacks.onError("Runtime", ...)
                  end
                  return xpcall(_2f_732_, _2f_733_)
                elseif ((_2f_730_0 == false) and (nil ~= _2f_731_0)) then
                  local msg = _2f_731_0
                  clear_stream()
              ...
              return _2f_729_(_2f_736_(...))
            elseif ((_2f_727_0 == false) and (nil ~= _2f_728_0)) then
              local msg = _2f_728_0
              clear_stream()
              return callbacks.onError("Compile", msg)
            else
          ...
          local function _2f_738_()
            opts.source = src_string
            return opts
          end
          _2f_726_(pcall(compiler.compile, form, _2f_738_()))
  ...
  local function _2f_744_(overrides, _3fopts)
    return repl(utils.copy(_3fopts, utils.copy(overrides)))
  end
  return setmetatable({}, {__call = _2f_744_, __index = {repl = repl}})
end
...
local function _75_(...)
  ...
  local function wrap_env(env)
    ...
    local function _2f_422_(_, key, value)
      if utils["string?"](key) then
    ...
    local function _2f_424_()
      local function putenv(k, v)
        local _2f_425_ = nil
        if utils["string?"](k) then
          _2f_425_ = compiler["global-unmangling"](k)
        else
          _2f_425_ = k
        end
        return _2f_425_, v
    ...
    return setmetatable({}, {__index = _2f_420_, __newindex = _2f_422_, __pairs = _2f_424_})
  end
  ...
  local function current_global_names(_3fenv)
    local mt = nil
    do
      local _2f_427_0 = getmetatable(_3fenv)
      if ((_G.type(_2f_427_0) == "table") and (nil ~= _2f_427_0.__pairs)) then
        local mtpairs = _2f_427_0.__pairs
        local tbl_14_ = {}
  ...
  local function load_code(code, _3fenv, _3ffilename)
    ...
    local _2f_430_0, _2f_431_0 = rawget(_G, "setfenv"), rawget(_G, "loadstring")
    if ((nil ~= _2f_430_0) and (nil ~= _2f_431_0)) then
      local setfenv = _2f_430_0
      local loadstring = _2f_431_0
  ...
  local function doc_2a(tgt, name)
    if not tgt then
      ...
      if ((type(tgt) == "function") or ((type(mt) == "table") and (type(mt.__call) == "function"))) then
        ...
        return string.format("(%s%s%s)\n  %s", name, _2f_433_, arglist, docstring)
      else
  ...
  local function compile_value(v)
    ...
    local chunk = {}
    local _2f_443_ = compiler.compile1(v, scope, chunk, opts)
    local _2f_444_ = _2f_443_[1]
    local v0 = _2f_444_[1]
    return v0
  end
  local function insert_meta(meta, k, v)
    ...
    table.insert(meta, _2f_445_())
    return meta
  end
  local function insert_arglist(meta, arg_list)
    local view_opts = {["escape-newlines?"] = true, ["line-length"] = math.huge, ["one-line?"] = true}
    table.insert(meta, "\"fnl/arglist\"")
    local function _2f_446_(_2f_241)
      return view(view(_2f_241, view_opts))
    end
    table.insert(meta, ("{" .. table.concat(utils.map(arg_list, _2f_446_), ", ") .. "}"))
    return meta
  end
  ...
  local function get_fn_name(ast, scope, fn_name, multi)
    if (fn_name and (fn_name[1] ~= "nil")) then
      local _2f_449_ = nil
      if not multi then
        _2f_449_ = compiler["declare-local"](fn_name, {}, scope, ast)
      else
        _2f_449_ = compiler["symbol-to-expression"](fn_name, scope)[1]
      end
      return _2f_449_, not multi, 3
    else
      return nil, true, 2
    end
  end
  local function compile_named_fn(ast, f_scope, f_chunk, parent, index, fn_name, local_3f, arg_name_list, f_metadata)
    ...
    local _2f_452_ = nil
    if local_3f then
      _2f_452_ = "local function %s(%s)"
    else
      _2f_452_ = "%s = function(%s)"
    end
    compiler.emit(parent, string.format(_2f_452_, fn_name, table.concat(arg_name_list, ", ")), ast)
  ...
  local function get_function_metadata(ast, arg_list, index)
    local function _2f_455_(_2f_241, _2f_242)
    ...
    local function _2f_457_(_2f_241, _2f_242)
      _2f_241["fnl/docstring"] = _2f_242
      return _2f_241
    end
    return maybe_metadata(ast, utils["kv-table?"], _2f_455_, maybe_metadata(ast, utils["string?"], _2f_457_, {["fnl/arglist"] = arg_list}, index))
  end
  SPECIALS.fn = function(ast, scope, parent)
    local f_scope = nil
    do
      local _2f_458_0 = compiler["make-scope"](scope)
      _2f_458_0.vararg = false
      f_scope = _2f_458_0
    end
    local f_chunk = {}
  ...
  SPECIALS.lua = function(ast, _, parent)
    ...
    local _2f_463_ = nil
    do
      local _2f_462_0 = utils["sym?"](ast[2])
      if (nil ~= _2f_462_0) then
        _2f_463_ = tostring(_2f_462_0)
      else
        _2f_463_ = _2f_462_0
      end
    end
    if ("nil" ~= _2f_463_) then
      table.insert(parent, {ast = ast, leaf = tostring(ast[2])})
    else
    end
    local _2f_467_ = nil
    do
      local _2f_466_0 = utils["sym?"](ast[3])
      if (nil ~= _2f_466_0) then
        _2f_467_ = tostring(_2f_466_0)
      else
        _2f_467_ = _2f_466_0
      end
    end
    if ("nil" ~= _2f_467_) then
  ...
  local function dot(ast, scope, parent)
    ...
    local _2f_470_ = compiler.compile1(lhs_node, scope, parent, {nval = 1})
    local lhs = _2f_470_[1]
    if (len == 2) then
      return tostring(lhs)
    else
      local indices = {}
      for i = 3, len do
        ...
        if (utils["string?"](index) and utils["valid-lua-identifier?"](index)) then
          ...
          local _2f_471_ = compiler.compile1(index, scope, parent, {nval = 1})
          local index0 = _2f_471_[1]
  ...
  local function disambiguate_3f(rootstr, parent)
    local function _2f_480_()
      local _2f_479_0 = get_prev_line(parent)
      if (nil ~= _2f_479_0) then
        local prev_line = _2f_479_0
        return prev_line:match("%)$")
      else
        return nil
      end
    end
    return ((rootstr:match("^{") or rootstr:match("^%(")) or _2f_480_())
  end
  SPECIALS.tset = function(ast, scope, parent)
    ...
    local keys = {}
    for i = 3, (#ast - 1) do
      local _2f_482_ = compiler.compile1(ast[i], scope, parent, {nval = 1})
      local key = _2f_482_[1]
  ...
  local function remove_until_condition(bindings, ast)
    ...
    for i = (#bindings - 1), 3, ( - 1) do
      local _2f_492_0 = clause_3f(bindings[i])
      if ((_2f_492_0 == false) or (_2f_492_0 == nil)) then
      elseif (nil ~= _2f_492_0) then
        local clause = _2f_492_0
  ...
  local function compile_until(_3fcondition, scope, chunk)
    if _3fcondition then
      local _2f_494_ = compiler.compile1(_3fcondition, scope, chunk, {nval = 1})
      local condition_lua = _2f_494_[1]
  ...
  local function native_method_call(ast, _scope, _parent, target, args)
    local _2f_500_ = ast
    local _ = _2f_500_[1]
    local _2f_0 = _2f_500_[2]
    local method_string = _2f_500_[3]
  ...
  local function method_call(ast, scope, parent)
    ...
    local _2f_502_ = compiler.compile1(ast[2], scope, parent, {nval = 1})
    local target = _2f_502_[1]
    local args = {}
    for i = 4, #ast do
      local subexprs = nil
      local _2f_503_ = nil
      ...
      subexprs = compiler.compile1(ast[i], scope, parent, {nval = _2f_503_})
  ...
  SPECIALS.hashfn = function(ast, scope, parent)
    ...
    local f_scope = nil
    do
      local _2f_511_0 = compiler["make-scope"](scope)
      _2f_511_0.vararg = false
      _2f_511_0.hashfn = true
      f_scope = _2f_511_0
    end
    local f_chunk = {}
  ...
  local function maybe_short_circuit_protect(ast, i, name, _2f_516_0)
    local _2f_517_ = _2f_516_0
    local mac = _2f_517_.macros
  ...
  local function operator_special(name, zero_arity, unary_prefix, ast, scope, parent)
    ...
    if (_2f_520_0 == 0) then
      ...
      return utils.expr(_2f_521_, "literal")
    elseif (_2f_520_0 == 1) then
  ...
  local function define_arithmetic_special(name, zero_arity, unary_prefix, _3flua_name)
    local _2f_525_ = nil
    do
      local _2f_524_0 = (_3flua_name or name)
      local function _2f_526_(...)
        return operator_special(_2f_524_0, zero_arity, unary_prefix, ...)
      end
      _2f_525_ = _2f_526_
    end
    SPECIALS[name] = _2f_525_
  ...
  local function bitop_special(native_name, lib_name, zero_arity, unary_prefix, ast, scope, parent)
    if (#ast == 1) then
      ...
      for i = 2, len do
        ...
        subexprs = compiler.compile1(ast[i], scope, parent, {nval = _2f_527_})
        utils.map(subexprs, tostring, operands)
      end
      if (#operands == 1) then
  ...
  SPECIALS.bnot = function(ast, scope, parent)
    compiler.assert((#ast == 2), "expected one argument", ast)
    local _2f_534_ = compiler.compile1(ast[2], scope, parent, {nval = 1})
    local value = _2f_534_[1]
    if utils.root.options.useBitLib then
  ...
  local function native_comparator(op, _2f_536_0, scope, parent)
    local _2f_537_ = _2f_536_0
    local _ = _2f_537_[1]
    local lhs_ast = _2f_537_[2]
    local rhs_ast = _2f_537_[3]
    local _2f_538_ = compiler.compile1(lhs_ast, scope, parent, {nval = 1})
    local lhs = _2f_538_[1]
    local _2f_539_ = compiler.compile1(rhs_ast, scope, parent, {nval = 1})
    local rhs = _2f_539_[1]
  ...
  local function make_compiler_env(ast, scope, parent, _3fopts)
    local provided = nil
    do
      local _2f_550_0 = (_3fopts or utils.root.options)
      if ((_G.type(_2f_550_0) == "table") and (_2f_550_0["compiler-env"] == "strict")) then
        provided = safe_compiler_env()
      elseif ((_G.type(_2f_550_0) == "table") and (nil ~= _2f_550_0.compilerEnv)) then
        local compiler_env = _2f_550_0.compilerEnv
        provided = compiler_env
      elseif ((_G.type(_2f_550_0) == "table") and (nil ~= _2f_550_0["compiler-env"])) then
        local compiler_env = _2f_550_0["compiler-env"]
        provided = compiler_env
      else
        local _ = _2f_550_0
        provided = safe_compiler_env()
  ...
  local _2f_558_ = _2f_556_(...)
  local dirsep = _2f_558_[1]
  local pathsep = _2f_558_[2]
  local pathmark = _2f_558_[3]
  ...
  local function search_module(modulename, _3fpathstring)
    ...
    local function try_path(path)
      ...
      local _2f_559_0 = (io.open(filename) or io.open(filename2))
      if (nil ~= _2f_559_0) then
        local file = _2f_559_0
        file:close()
        return filename
      else
        local _ = _2f_559_0
    ...
    local function find_in_path(start, _3ftried_paths)
      local _2f_561_0 = fullpath:match(pattern, start)
      if (nil ~= _2f_561_0) then
        local path = _2f_561_0
        local _2f_562_0, _2f_563_0 = try_path(path)
        if (nil ~= _2f_562_0) then
          local filename = _2f_562_0
          return filename
        elseif ((_2f_562_0 == nil) and (nil ~= _2f_563_0)) then
          local error = _2f_563_0
          local function _2f_565_()
            local _2f_564_0 = (_3ftried_paths or {})
            table.insert(_2f_564_0, error)
            return _2f_564_0
          end
          return find_in_path((start + #path + 1), _2f_565_())
        else
          return nil
        end
      else
        local _ = _2f_561_0
        local function _2f_567_()
  ...
  local function make_searcher(_3foptions)
    local function _2f_570_(module_name)
      local opts = utils.copy(utils.root.options)
      for k, v in pairs((_3foptions or {})) do
        opts[k] = v
      end
      opts["module-name"] = module_name
      local _2f_571_0, _2f_572_0 = search_module(module_name)
      if (nil ~= _2f_571_0) then
        local filename = _2f_571_0
        local function _2f_573_(...)
          return utils["fennel-module"].dofile(filename, opts, ...)
        end
        return _2f_573_, filename
      elseif ((_2f_571_0 == nil) and (nil ~= _2f_572_0)) then
        local error = _2f_572_0
        return error
      else
        return nil
      end
  ...
  local function fennel_macro_searcher(module_name)
    local opts = nil
    do
      local _2f_575_0 = utils.copy(utils.root.options)
      _2f_575_0["module-name"] = module_name
      _2f_575_0.env = "_COMPILER"
      _2f_575_0.requireAsInclude = false
      _2f_575_0.allowedGlobals = nil
      opts = _2f_575_0
    end
    local _2f_576_0 = search_module(module_name, utils["fennel-module"]["macro-path"])
    if (nil ~= _2f_576_0) then
      local filename = _2f_576_0
      local _2f_577_ = nil
      if (opts["compiler-env"] == _G) then
        ...
        local function _2f_579_(...)
          return utils["fennel-module"].dofile(filename, opts, ...)
        end
        _2f_577_ = _2f_579_
      end
      return _2f_577_, filename
    else
      return nil
    end
  end
  local function lua_macro_searcher(module_name)
    local _2f_582_0 = search_module(module_name, package.path)
    if (nil ~= _2f_582_0) then
      local filename = _2f_582_0
      local code = nil
      do
        ...
        code = close_handlers_10_(_G.xpcall(_2f_584_, (package.loaded.fennel or debug).traceback))
      end
  ...
  local function search_macro_module(modname, n)
    local _2f_586_0 = macro_searchers[n]
    if (nil ~= _2f_586_0) then
      local f = _2f_586_0
      local _2f_587_0, _2f_588_0 = f(modname)
      if ((nil ~= _2f_587_0) and true) then
        local loader = _2f_587_0
        local _3ffilename = _2f_588_0
  ...
  local function sandbox_fennel_module(modname)
    if ((modname == "fennel.macros") or (((package and package.loaded) and ("table" == type(package.loaded[modname]))) and (package.loaded[modname].metadata == compiler.metadata))) then
      local function _2f_591_(_, ...)
        return (compiler.metadata):setall(...)
      end
      return {metadata = {setall = _2f_591_}, view = view}
    else
      return nil
    end
  end
  local function _2f_593_(modname)
    local function _2f_594_()
    ...
    return ((macro_loaded[modname] or sandbox_fennel_module(modname)) or _2f_594_())
  end
  safe_require = _2f_593_
  ...
  local function resolve_module_name(_2f_595_0, _scope, _parent, opts)
    local _2f_596_ = _2f_595_0
    local second = _2f_596_[2]
    local filename = _2f_596_.filename
  ...
  local function include_path(ast, opts, path, mod, fennel_3f)
    ...
    do
      ...
      src = close_handlers_10_(_G.xpcall(_2f_602_, (package.loaded.fennel or debug).traceback))
    end
  ...
  SPECIALS.include = function(ast, scope, parent, opts)
    ...
    local modexpr = nil
    do
      local _2f_605_0, _2f_606_0 = pcall(resolve_module_name, ast, scope, parent, opts)
      if ((_2f_605_0 == true) and (nil ~= _2f_606_0)) then
        local modname = _2f_606_0
    ...
    if ((modexpr.type ~= "literal") or ((modexpr[1]):byte() ~= 34)) then
      ...
      _ = nil
      local res = nil
      local function _2f_610_()
        local _2f_609_0 = search_module(mod)
        if (nil ~= _2f_609_0) then
          local fennel_path = _2f_609_0
          return include_path(ast, opts, fennel_path, mod, true)
        else
          local _2f_0 = _2f_609_0
      ...
      res = ((((utils["member?"](mod, (utils.root.options.skipInclude or {})) and opts.fallback(modexpr, true)) or include_circular_fallback(mod, modexpr, opts.fallback, ast)) or utils.root.scope.includes[mod]) or _2f_610_())
...
package.preload["fennel.specials"] = (package.preload["fennel.specials"] or _75_)
local function _183_(...)
  ...
  local function assert_compile(condition, msg, ast, _3ffallback_ast)
    if not condition then
      local _2f_267_ = (utils.root.options or {})
      local error_pinpoint = _2f_267_["error-pinpoint"]
      local source = _2f_267_.source
      local unfriendly = _2f_267_.unfriendly
      local ast0 = nil
  ...
  local function serialize_string(str)
    local function _2f_272_(_2f_241)
      return ("\\" .. _2f_241:byte())
    end
    return string.gsub(string.gsub(string.format("%q", str), ".", serialize_subst), "[\128-\255]", _2f_272_)
  end
  local function global_mangling(str)
    if utils["valid-lua-identifier?"](str) then
      return str
    else
      local function _2f_273_(_2f_241)
        return string.format("_%02x", _2f_241:byte())
      end
      return ("__fnl_global__" .. str:gsub("[^%w]", _2f_273_))
    end
  end
  local function global_unmangling(identifier)
    local _2f_275_0 = string.match(identifier, "^__fnl_global__(.*)$")
    if (nil ~= _2f_275_0) then
      local rest = _2f_275_0
      local _2f_276_0 = nil
      local function _2f_277_(_2f_241)
        return string.char(tonumber(_2f_241:sub(2), 16))
      end
      _2f_276_0 = string.gsub(rest, "_[%da-f][%da-f]", _2f_277_)
      return _2f_276_0
    else
      local _ = _2f_275_0
      return identifier
  ...
  local function local_mangling(str, scope, ast, _3ftemp_manglings)
    ...
    mangling = string.gsub(string.gsub(raw, "-", "_"), "[^%w_]", _2f_281_)
  ...
  local function autogensym(base, scope)
    local _2f_285_0 = utils["multi-sym?"](base)
    if (nil ~= _2f_285_0) then
      local parts = _2f_285_0
      return combine_auto_gensym(parts, autogensym(parts[1], scope))
    else
      local _ = _2f_285_0
      local function _2f_286_()
        local mangling = gensym(scope, base:sub(1, ( - 2)), "auto")
        do end (scope.autogensyms)[base] = mangling
        return mangling
      end
      return (scope.autogensyms[base] or _2f_286_())
    end
  end
  local function check_binding_valid(symbol, scope, ast, _3fopts)
    ...
    local macro_3f = nil
    do
      local _2f_288_0 = _3fopts
      if (nil ~= _2f_288_0) then
        _2f_288_0 = _2f_288_0["macro?"]
      else
      end
      macro_3f = _2f_288_0
    end
  ...
  local function flatten_chunk(file_sourcemap, chunk, tab, depth)
    if chunk.leaf then
      local _2f_300_ = utils["ast-source"](chunk.ast)
      local filename = _2f_300_.filename
      local line = _2f_300_.line
      ...
      do
        local _2f_301_0 = tab
        if (_2f_301_0 == true) then
          tab0 = "  "
        elseif (_2f_301_0 == false) then
          tab0 = ""
        elseif (_2f_301_0 == tab) then
          tab0 = tab
        elseif (_2f_301_0 == nil) then
          tab0 = ""
        else
          tab0 = nil
        end
  ...
  local function make_metadata()
    local function _2f_309_(self, tgt, _3fkey)
      if self[tgt] then
        if (nil ~= _3fkey) then
    ...
    local function _2f_312_(self, tgt, key, value)
      self[tgt] = (self[tgt] or {})
      do end (self[tgt])[key] = value
      return tgt
    end
    local function _2f_313_(self, tgt, ...)
      local kv_len = select("#", ...)
      local kvs = {...}
      if ((kv_len % 2) ~= 0) then
    ...
    return setmetatable({}, {__index = {get = _2f_309_, set = _2f_312_, setall = _2f_313_}, __mode = "k"})
  end
  ...
  local function handle_compile_opts(exprs, parent, opts, ast)
    ...
    if opts.target then
      ...
      emit(parent, string.format("%s = %s", opts.target, _2f_321_()), ast)
    else
    end
  ...
  local function find_macro(ast, scope)
    local macro_2a = nil
    do
      local _2f_324_0 = utils["sym?"](ast[1])
      if (_2f_324_0 ~= nil) then
        local _2f_325_0 = tostring(_2f_324_0)
        if (_2f_325_0 ~= nil) then
          macro_2a = scope.macros[_2f_325_0]
        else
          macro_2a = _2f_325_0
        end
      else
  ...
  local function propagate_trace_info(_2f_329_0, _index, node)
    local _2f_330_ = _2f_329_0
    local byteend = _2f_330_.byteend
    local bytestart = _2f_330_.bytestart
    local filename = _2f_330_.filename
    local line = _2f_330_.line
    do
  ...
  local function quote_literal_nils(index, node, parent)
    if (parent and utils["list?"](parent)) then
      for i = 1, utils.maxn(parent) do
        local _2f_332_0 = parent[i]
        if (_2f_332_0 == nil) then
  ...
  local function macroexpand_2a(ast, scope, _3fonce)
    ...
    if utils["list?"](ast) then
      _2f_336_0 = find_macro(ast, scope)
    else
      _2f_336_0 = nil
    end
    if (_2f_336_0 == false) then
      return ast
    elseif (nil ~= _2f_336_0) then
      local macro_2a = _2f_336_0
      ...
      ok, transformed = xpcall(_2f_338_, _2f_339_())
      local function _2f_340_(...)
        return propagate_trace_info(ast, ...)
      end
      utils["walk-tree"](transformed, comp(_2f_340_, quote_literal_nils))
  ...
  local function compile_function_call(ast, scope, parent, opts, compile1, len)
    ...
    for i = 2, len do
      ...
      subexprs = compile1(ast[i], scope, parent, {nval = _2f_346_})
  ...
  local function compile_varg(ast, scope, parent, opts)
    ...
    if scope.hashfn then
      _2f_351_ = "use $... in hashfn"
    else
      _2f_351_ = "unexpected vararg"
    end
    assert_compile(scope.vararg, _2f_351_, ast)
  ...
  local function serialize_number(n)
    local _2f_354_0 = string.gsub(tostring(n), ",", ".")
    return _2f_354_0
  end
  local function compile_scalar(ast, _scope, parent, opts)
    local serialize = nil
    do
      local _2f_355_0 = type(ast)
      if (_2f_355_0 == "nil") then
        serialize = tostring
      elseif (_2f_355_0 == "boolean") then
        serialize = tostring
      elseif (_2f_355_0 == "string") then
        serialize = serialize_string
      elseif (_2f_355_0 == "number") then
  ...
  local function compile_table(ast, scope, parent, opts, compile1)
    local function escape_key(k)
      if ((type(k) == "string") and utils["valid-lua-identifier?"](k)) then
        ...
        local _2f_357_ = compile1(k, scope, parent, {nval = 1})
        local compiled = _2f_357_[1]
    ...
    do
      ...
      for k in utils.stablepairs(ast) do
        local val_19_ = nil
        if not keys[k] then
          local _2f_360_ = compile1(ast[k], scope, parent, {nval = 1})
          local v = _2f_360_[1]
  ...
  local function destructure(to, from, ast, scope, parent, opts)
    local opts0 = (opts or {})
    local _2f_364_ = opts0
    local declaration = _2f_364_.declaration
    local forceglobal = _2f_364_.forceglobal
    local forceset = _2f_364_.forceset
    local isvar = _2f_364_.isvar
    local symtype = _2f_364_.symtype
    ...
    local function getname(symbol, up1)
      ...
      if declaration then
        ...
        local _2f_366_ = parts
        local first = _2f_366_[1]
    ...
    local function compile_top_target(lvalues)
      local inits = nil
      local function _2f_371_(_2f_241)
      ...
      inits = utils.map(lvalues, _2f_371_)
    ...
    local function destructure_kv_rest(s, v, left, excluded_keys, destructure1)
      ...
      exclude_str = table.concat(_2f_378_, ", ")
    ...
    local function destructure_table(left, rightexprs, top_3f, destructure1)
      ...
      do
        local _2f_380_0 = nil
        if top_3f then
          _2f_380_0 = exprs1(compile1(from, scope, parent))
        else
          _2f_380_0 = exprs1(rightexprs)
        end
        if (_2f_380_0 == "") then
          right = "nil"
        elseif (nil ~= _2f_380_0) then
          local right0 = _2f_380_0
          right = right0
        else
          right = nil
        end
  ...
  local function compile_asts(asts, options)
    ...
    local _2f_395_ = utils.root
    _2f_395_["set-reset"](_2f_395_)
  ...
  local function traceback_frame(info)
    ...
    elseif (info.what == "C") then
      ...
      if (info.what == "Lua") then
        ...
        return string.format("\9%s:%d: in function %s", info.short_src, info.currentline, _2f_400_())
  ...
  local function traceback(_3fmsg, _3fstart)
    ...
    if ((msg:find("^%g+:%d+:%d+ Compile error:.*") or msg:find("^%g+:%d+:%d+ Parse error:.*")) and not utils["debug-on?"]("trace")) then
      ...
      while not done_3f do
        do
          local _2f_404_0 = debug.getinfo(level, "Sln")
          if (_2f_404_0 == nil) then
            done_3f = true
          elseif (nil ~= _2f_404_0) then
            local info = _2f_404_0
  ...
  local function do_quote(form, scope, parent, runtime_3f)
    ...
    elseif utils["list?"](form) then
      local mapped = nil
      local function _2f_412_()
        return nil
      end
      mapped = utils.kvmap(form, entry_transform(_2f_412_, q))
      local filename = nil
      if form.filename then
        filename = string.format("%q", form.filename)
      else
    ...
    elseif utils["sequence?"](form) then
      ...
      local _2f_415_ = nil
      if source then
        _2f_415_ = source.line
      else
        _2f_415_ = "nil"
      end
      return string.format("setmetatable({%s}, {filename=%s, line=%s, sequence=%s})", mixed_concat(mapped, ", "), filename, _2f_415_, "(getmetatable(sequence()))['sequence']")
    elseif (type(form) == "table") then
      ...
      return string.format("setmetatable({%s}, {filename=%s, line=%s})", mixed_concat(mapped, ", "), filename, _2f_418_())
...
local function _300_(...)
  ...
  local function read_line(filename, line, _3fsource)
    if _3fsource then
      ...
      local function _2f_187_()
        for _ = 2, line do
          f:read()
        end
        return f:read()
      end
      return close_handlers_10_(_G.xpcall(_2f_187_, (package.loaded.fennel or debug).traceback))
    end
  end
  ...
  local function highlight_line(codeline, col, _3fendcol, opts)
    if ((opts and (false == opts["error-pinpoint"])) or ((os and os.getenv) and os.getenv("NO_COLOR"))) then
      ...
      local _2f_190_ = (opts or {})
      local error_pinpoint = _2f_190_["error-pinpoint"]
      ...
      local _2f_192_ = (error_pinpoint or {"\27[7m", "\27[0m"})
      local open = _2f_192_[1]
      local close = _2f_192_[2]
      return (sub(codeline, 1, col) .. open .. sub(codeline, (col + 1), (endcol + 1)) .. close .. sub(codeline, (endcol + 2), eol))
    end
  end
  local function friendly_msg(msg, _2f_194_0, source, opts)
    local _2f_195_ = _2f_194_0
    local col = _2f_195_.col
    local endcol = _2f_195_.endcol
    local endline = _2f_195_.endline
    local filename = _2f_195_.filename
    local line = _2f_195_.line
  ...
  local function assert_compile(condition, msg, ast, source, opts)
    if not condition then
      local _2f_199_ = utils["ast-source"](ast)
      local col = _2f_199_.col
      local filename = _2f_199_.filename
      local line = _2f_199_.line
...
package.preload["fennel.friend"] = (package.preload["fennel.friend"] or _300_)
local function _313_(...)
  ...
  local function granulate(getchunk)
    ...
    local function _2f_201_(parser_state)
      if not done_3f then
        if (index <= #c) then
          ...
          local _2f_202_0 = getchunk(parser_state)
          local function _2f_203_()
            local char = _2f_202_0
            return (char ~= "")
          end
          if ((nil ~= _2f_202_0) and _2f_203_()) then
            local char = _2f_202_0
            c = char
            index = 2
            return c:byte()
    ...
    local function _2f_207_()
      c = ""
      return nil
    end
    return _2f_201_, _2f_207_
  end
  ...
  local function parser_fn(getbyte, filename, _2f_211_0)
    local _2f_212_ = _2f_211_0
    local options = _2f_212_
    local comments = _2f_212_.comments
    local source = _2f_212_.source
    local unfriendly = _2f_212_.unfriendly
    local stack = {}
    ...
    local function whitespace_3f(b)
      local function _2f_220_()
        local _2f_219_0 = options.whitespace
        if (nil ~= _2f_219_0) then
          _2f_219_0 = _2f_219_0[b]
        else
        end
        return _2f_219_0
      end
      return (((b == 32) or ((9 <= b) and (b <= 13))) or _2f_220_())
    end
    ...
    local function parse_stream()
      ...
      local function dispatch(v)
        local _2f_224_0 = stack[#stack]
        if (_2f_224_0 == nil) then
          retval, done_3f, whitespace_since_dispatch = v, true, false
          return nil
        elseif ((_G.type(_2f_224_0) == "table") and (nil ~= _2f_224_0.prefix)) then
          local prefix = _2f_224_0.prefix
          local source0 = nil
          do
            local _2f_225_0 = table.remove(stack)
            set_source_fields(_2f_225_0)
            source0 = _2f_225_0
          end
      ...
      local function badend()
        ...
        return parse_error(string.format("expected closing delimiter%s %s", _2f_227_, string.char(unpack(accum))))
      end
      ...
      local function parse_comment(b, contents)
        if (b and (10 ~= b)) then
          local function _2f_230_()
            table.insert(contents, string.char(b))
            return contents
          end
          return parse_comment(getb(), _2f_230_())
      ...
      local function add_comment_at(comments0, index, node)
        local _2f_234_0 = comments0[index]
        if (nil ~= _2f_234_0) then
          local existing = _2f_234_0
      ...
      local function parse_string_loop(chars, b, state)
        ...
        local state0 = nil
        do
          local _2f_245_0 = {state, b}
          if (((_G.type(_2f_245_0) == "table") and (_2f_245_0[1] == "base")) and (_2f_245_0[2] == 92)) then
            state0 = "backslash"
          elseif (((_G.type(_2f_245_0) == "table") and (_2f_245_0[1] == "base")) and (_2f_245_0[2] == 34)) then
            state0 = "done"
          elseif (((_G.type(_2f_245_0) == "table") and (_2f_245_0[1] == "backslash")) and (_2f_245_0[2] == 10)) then
      ...
      local function parse_string()
        ...
        local _2f_249_0 = (rawget(_G, "loadstring") or load)(("return " .. formatted))
        if (nil ~= _2f_249_0) then
          local load_fn = _2f_249_0
          return dispatch(load_fn())
        elseif (_2f_249_0 == nil) then
      ...
      local function parse_number(rawstr)
        ...
        if rawstr:match("^%d") then
          ...
          local _2f_255_0 = tonumber(number_with_stripped_underscores)
          if (nil ~= _2f_255_0) then
            local x = _2f_255_0
            dispatch(x)
            return true
          else
...
package.preload["fennel.parser"] = (package.preload["fennel.parser"] or _313_)
local utils = nil
local function _359_(...)
  ...
  local function number__3estring(n)
    local _2f_76_0 = string.gsub(tostring(n), ",", ".")
    return _2f_76_0
  end
    ...
    local function validate_utf8(str0, index)
      ...
      do
        ...
        for _, init0 in ipairs(inits) do
          ...
          local function _409_(_2f_77_, _2f_78_, _2f_79_)
            return ((_2f_77_ <= _2f_78_) and (_2f_78_ <= _2f_79_))
          end
          ret = ((byte and _409_(init0["min-byte"], byte, init0["max-byte"])) and init0)
        end
        init = ret
      end
      local code = nil
      local function _2f_80_()
        local code0 = nil
        if init then
      ...
      local function _411_(_2f_82_, _2f_83_, _2f_84_)
        return ((_2f_82_ <= _2f_83_) and (_2f_83_ <= _2f_84_))
      end
      if ((code and _411_(init["min-code"], code, init["max-code"])) and not ((55296 <= code) and (code <= 57343))) then
        return init.len
      else
        return nil
      end
  ...
  local function pp_string(str, options, indent)
    ...
    escs = setmetatable({["\7"] = "\\a", ["\8"] = "\\b", ["\9"] = "\\t", ["\n"] = _2f_88_, ["\11"] = "\\v", ["\12"] = "\\f", ["\13"] = "\\r", ["\""] = "\\\"", ["\\"] = "\\\\"}, {__index = _2f_90_})
  ...
  local function _2f_93_(x, options, indent, colon_3f)
    ...
    local tv = type(x0)
    local function _2f_96_()
      local _2f_95_0 = getmetatable(x0)
      if ((_G.type(_2f_95_0) == "table") and true) then
        local __fennelview = _2f_95_0.__fennelview
        return __fennelview
      else
        return nil
      end
    end
    if ((tv == "table") or ((tv == "userdata") and _2f_96_())) then
      return pp_table(x0, options0, indent0)
    elseif (tv == "number") then
      return number__3estring(x0)
    else
      local function _2f_98_()
      ...
      if (((tv == "string") and colon_string_3f(x0)) and _2f_98_()) then
        return (":" .. x0)
...
package.preload["fennel.view"] = (package.preload["fennel.view"] or _359_)
local function _423_(...)
  ...
  local len = nil
  do
    local _2f_103_0, _2f_104_0 = pcall(require, "utf8")
    if ((_2f_103_0 == true) and (nil ~= _2f_104_0)) then
      local utf8 = _2f_104_0
      len = utf8.len
    else
      local _ = _2f_103_0
      len = string.len
  ...
  local function kv_compare(a, b)
    local _2f_106_0, _2f_107_0 = type(a), type(b)
    if (((_2f_106_0 == "number") and (_2f_107_0 == "number")) or ((_2f_106_0 == "string") and (_2f_107_0 == "string"))) then
      return (a < b)
    else
      local function _2f_108_()
        local a_t = _2f_106_0
        local b_t = _2f_107_0
        return (a_t ~= b_t)
      end
      if (((nil ~= _2f_106_0) and (nil ~= _2f_107_0)) and _2f_108_()) then
        local a_t = _2f_106_0
        local b_t = _2f_107_0
  ...
  local function stablepairs(t)
    local mt_keys = nil
    do
      local _2f_112_0 = getmetatable(t)
      if (nil ~= _2f_112_0) then
        _2f_112_0 = _2f_112_0.keys
      else
      end
      mt_keys = _2f_112_0
    end
    local succ, prev, first_mt = nil, nil, nil
    local function _2f_114_(_2f_241)
      return t[_2f_241]
    end
    succ, prev, first_mt = add_stable_keys({}, nil, (mt_keys or {}), _2f_114_)
    ...
    do
      ...
      table.sort(_2f_115_0, kv_compare)
      pairs_keys = _2f_115_0
    end
    ...
    local function stablenext(tbl, key)
      ...
      if (nil ~= _2f_118_0) then
        local next_key = _2f_118_0
        local _2f_120_0 = tbl[next_key]
        if (_2f_120_0 ~= nil) then
          return next_key, _2f_120_0
        else
          return _2f_120_0
        end
      else
    ...
    if (0 == #path) then
      ...
      do
        ...
        for _, k in ipairs(path) do
          ...
          local _2f_124_0 = type(t)
          if (_2f_124_0 == "table") then
            t = t[k]
          else
            t = nil
          end
  ...
  local function map(t, f, _3fout)
    ...
    if (type(f) == "function") then
      ...
      local function _2f_128_(_2f_241)
        return _2f_241[f]
      end
      f0 = _2f_128_
    end
    for _, x in ipairs(t) do
      local _2f_130_0 = f0(x)
      if (nil ~= _2f_130_0) then
        local v = _2f_130_0
        table.insert(out, v)
      else
      end
  ...
  local function kvmap(t, f, _3fout)
    ...
    if (type(f) == "function") then
      ...
      local function _2f_132_(_2f_241)
        return _2f_241[f]
      end
      f0 = _2f_132_
    end
    for k, x in stablepairs(t) do
      local _2f_134_0, _2f_135_0 = f0(k, x)
      if ((nil ~= _2f_134_0) and (nil ~= _2f_135_0)) then
        local key = _2f_134_0
        local value = _2f_135_0
        out[key] = value
      elseif (nil ~= _2f_134_0) then
        local value = _2f_134_0
  ...
  local function member_3f(x, tbl, _3fn)
    local _2f_138_0 = tbl[(_3fn or 1)]
    if (_2f_138_0 == x) then
      return true
    elseif (_2f_138_0 == nil) then
      return nil
    else
      local _ = _2f_138_0
  ...
  local function allpairs(tbl)
    ...
    local function allpairs_next(_, state)
      ...
      elseif next_state then
        ...
        local _2f_141_0 = getmetatable(t)
        if ((_G.type(_2f_141_0) == "table") and true) then
          local __index = _2f_141_0.__index
          if ("table" == type(__index)) then
            t = __index
  ...
  local function list__3estring(self, _3fview, _3foptions, _3findent)
    ...
    local view0 = nil
    if _3fview then
      local function _2f_145_(_2f_241)
  ...
  local expr_mt = nil
  local function _2f_147_(x)
    return tostring(deref(x))
  end
  expr_mt = {"EXPR", __tostring = _2f_147_}
  ...
  local getenv = nil
  local function _2f_148_()
    return nil
  end
  getenv = ((os and os.getenv) or _2f_148_)
  ...
  local function sym(str, _3fsource)
    ...
    return setmetatable(_2f_149_, symbol_mt)
  end
  nil_sym = sym("nil")
  local function sequence(...)
    local function _2f_152_(seq, view0, inspector, indent)
      local opts = nil
      do
    ...
    return setmetatable({...}, {__fennelview = _2f_152_, sequence = sequence_marker})
  end
  local function expr(strcode, etype)
    return setmetatable({strcode, type = etype}, expr_mt)
  end
  local function comment_2a(contents, _3fsource)
    local _2f_153_ = (_3fsource or {})
    local filename = _2f_153_.filename
    local line = _2f_153_.line
  ...
  local function varg(_3fsource)
    ...
    return setmetatable(_2f_154_, varg_mt)
  end
  ...
  local function multi_sym_3f(str)
    ...
    elseif (type(str) ~= "string") then
      ...
      return (((((((str:match("%.") or str:match(":")) and not str:match("%.%.")) and (str:byte() ~= string.byte("."))) and (str:byte() ~= string.byte(":"))) and (str:byte(( - 1)) ~= string.byte("."))) and (str:byte(( - 1)) ~= string.byte(":"))) and _2f_160_())
    end
  end
  ...
  local root = nil
  local function _2f_165_()
  end
  root = {chunk = nil, options = nil, reset = _2f_165_, scope = nil}
  root["set-reset"] = function(_2f_166_0)
    local _2f_167_ = _2f_166_0
    local chunk = _2f_167_.chunk
    local options = _2f_167_.options
    local reset = _2f_167_.reset
    local scope = _2f_167_.scope
    root.reset = function()
  ...
  local function warn(msg, _3fast)
    if (_G.io and _G.io.stderr) then
      local loc = nil
      do
        local _2f_169_0 = ast_source(_3fast)
        if (((_G.type(_2f_169_0) == "table") and (nil ~= _2f_169_0.filename)) and (nil ~= _2f_169_0.line)) then
          local filename = _2f_169_0.filename
          local line = _2f_169_0.line
          loc = (filename .. ":" .. line .. ": ")
        else
          local _ = _2f_169_0
          loc = ""
  ...
  local warned = {}
  local function check_plugin_version(_2f_172_0)
    local _2f_173_ = _2f_172_0
    local plugin = _2f_173_
    local name = _2f_173_.name
    local versions = _2f_173_.versions
  ...
  local function hook_opts(event, _3foptions, ...)
    local plugins = nil
    local function _2f_176_(...)
      local _2f_175_0 = _3foptions
      if (nil ~= _2f_175_0) then
        _2f_175_0 = _2f_175_0.plugins
      else
      end
      return _2f_175_0
    end
    local function _2f_179_(...)
      local _2f_178_0 = root.options
...
local function eval(str, _3foptions, ...)
  ...
  loader = specials["load-code"](lua_source, env, _2f_750_(...))
  opts.filename = nil
  return loader(...)
end
...
local function syntax()
  ...
  for k, v in pairs(compiler.scopes.global.specials) do
    ...
    do end (out)[k] = {["binding-form?"] = utils["member?"](k, binding_3f), ["body-form?"] = metadata["fnl/body-form?"], ["define?"] = utils["member?"](k, define_3f), ["deprecated?"] = utils["member?"](k, deprecated), ["special?"] = true}
  end
  ...
  for k, v in pairs(_G) do
    local _2f_751_0 = type(v)
    if (_2f_751_0 == "function") then
      out[k] = {["function?"] = true, ["global?"] = true}
    elseif (_2f_751_0 == "table") then
...
do
  ...
  local _ = nil
  local function _2f_755_()
    return mod
  end
  package.preload[module_name] = _2f_755_
  _ = nil
  local env = nil
  do
    local _2f_756_0 = specials["make-compiler-env"](nil, compiler.scopes.compiler, {})
    _2f_756_0.utils = utils
    _2f_756_0.fennel = mod
    _2f_756_0["get-function-metadata"] = specials["get-function-metadata"]
    env = _2f_756_0
  end
